...
| TC-821 | The Rust review records exact Rust 1.98.1, `CARGO_BUILD_JOBS=2`, pinned Node/npm host versions, Rust dependency and emitted-package license results, and proof that no hosted workflow or publication ran | Inspection | P0 | NFR-008-AC-4, NFR-008-AC-5, NFR-008-AC-6 | 🚧 |
