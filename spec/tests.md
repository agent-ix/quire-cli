...
| FR-017 coverage subcommand (declarative rollup over two roots) | AC-1..12 | IT-107, IT-108 (CR-011 the engine capabilities reach a command line), IT-109 (finding lines lead with `row_id` — #51), IT-089 (human census on stderr), TC-740 (JSON payload byte-identical + no-model refusal), TC-810 (document root is `<scope>/spec`), IT-087 (code walk excludes it), TC-811 + IT-086 (missing root named + typed kind), IT-092 (`--strict`), TC-797 (zero matched rows ≠ full coverage), TC-090 (thin boundary) | ✅ Complete |
