...
| NFR-007 Exact qualified Rust toolchain | static audit + locked local qualification | TC-142 (all compiler declarations exact, exhaustive workflow scan, mutation-sensitive), TC-143 (qualified engine pin + exact local gate record) | 🚧 |
