...
| US-007 Consumer installs native Quire through npm | AC-1..4 | IT-159..163, TC-816 | 🚧 Specified; implementation pending |
...
| FR-022 npm launcher process contract | AC-1..7 | IT-159 (offline install + transparent process), IT-160 (unsupported/missing), IT-161 (chmod refusal + spawn error), IT-162 (signal), TC-815 (minimal shim and single catalog), TC-820 (semantic containment) | 🚧 Specified; implementation pending |
| FR-023 Rust-owned npm package assembly | AC-1..8 | TC-815 (catalog), TC-816 (complete deterministic packages), TC-817 (missing/wrong/extra input and atomic refusal), IT-159 (offline installation), IT-163 (`npm pack` membership) | 🚧 Specified; implementation pending |
| FR-024 Rust-owned npm release version contract | AC-1..6 | TC-818 (transactional version contract), IT-164 (binary/version disagreement), TC-819 (manual workflow and native tooling audit) | 🚧 Specified; implementation pending |
...
| NFR-008 Native npm distribution tooling boundary | Rust source/mutation audit + local host-seam qualification | TC-815, TC-819, TC-820, TC-821, IT-159, IT-163 | 🚧 Specified; implementation pending |
...
| TC-821 | The Rust review records exact Rust 1.98.1, `CARGO_BUILD_JOBS=2`, the observed local Node/npm host versions and exact release pins, Rust dependency and emitted-package license results, and proof that no hosted workflow or publication ran | Inspection | P0 | NFR-008-AC-4, NFR-008-AC-5, NFR-008-AC-6 | 🚧 |
