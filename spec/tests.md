...
| IT-101 | A **relative document path** with `--scope` and no `--module` resolves under the scope and validates against modules discovered from it: exit 0, empty stdout, empty stderr (`cli_validate::it_101_*`) | Integration | P1 | FR-004-AC-19 | ✅ |
