...
| FND-006 | medium | **FIXED when the first executable fixture exercised the upstream API.** The initial AC-4 incorrectly grouped an unreadable document with export-wide inability. quire-rs FR-068 deliberately exports an unreadable document as an `unknown` required-relation observation with a reason. FR-020/IT-141 now preserve three distinct outcomes: empty success, bounded unknown, and no-output failure. | FR-020-AC-4; IT-141; quire-rs FR-068-AC-6 |
